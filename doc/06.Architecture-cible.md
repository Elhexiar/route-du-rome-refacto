...
Le projet s'appuie sur une **Clean Architecture**, avec une séparation stricte entre chaque couche via des interfaces. Cela permettra de facilement changer les dépendance externe et facilitera grandement les tests.
